                                        ...
                                        <td>
                                          <div>
                                            ...
                                            <div className="progress progress-md">
                                              <div className={styles.width85 + " progress-bar bg-success"} role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                          </div>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div>
                                            ...
                                            <div className="progress progress-md">
                                              <div className={styles.width65 + " progress-bar bg-success"} role="progressbar" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                          </div>
                                        </td>
                                        <td><div className="badge badge-opacity-warning">In progress</div></td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div>
                                            ...
                                            <div className="progress progress-md">style
                                              <div className={styles.width38 + " progress-bar bg-warning"} role="progressbar" aria-valuenow="38" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                          </div>
                                        </td>
                                        <td><div className="badge badge-opacity-warning">In progress</div></td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div>
                                            ...
                                            <div className="progress progress-md">
                                              <div className={styles.width15 + " progress-bar bg-danger"} role="progressbar" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                          </div>
                                        </td>
